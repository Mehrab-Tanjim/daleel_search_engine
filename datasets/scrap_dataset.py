...
class HadithScraper:
    ...
    def extract_hadiths(self, book_data: dict) -> List[dict]:
        ...
        for idx, container in enumerate(hadith_containers):
            ...
            grade = container.find(class_='english_grade').get_text(strip=True)
    ...
    def scrape_books(self) -> List[dict]:
        ...
        for book_data in tqdm(books_data):
...
if __name__ == '__main__':
    ...
    scraper = HadithScraper(base_url, data_dir="./data/Musnad Ahmad")
